...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', help='names file for nodes that were placed onto the tree. If provided we write out those names (probably not needed)')
    parser.add_argument('-l', help='filename that we will create with a a list of all leaf names of the final tree, one per line')
